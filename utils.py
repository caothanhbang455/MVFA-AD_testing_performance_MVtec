...
# nếu tăng prompts, tăng kiểu format sẽ ntn thì sẽ như thế nào
...
#Ma trận tịnh tiến được dùng để di chuyển (dịch chuyển) 
# một điểm trong không gian 2D từ vị trí ban đầu sang vị 
# trí mới theo vector (a, b).
